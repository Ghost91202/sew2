...
export default function Whywe( params ) {
    return (
        <div className="flex flex-col gap-5 p-10 lg:p-20">
            <h1 className=" lg:text-4xl font-semibold">This makes IFE unique</h1>
            <div className=" grid sm:grid-cols-2 grid-cols-1 lg:grid-cols-4 grid-flow-row gap-5">
             <div className="flex  gap-2">
                ...
                <div>
                    ...
                    <h3 className=" text-sm lg:text-lg  text-black/40 text-balance">
