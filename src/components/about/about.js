        ...
        <div className="w-screen">
            ...
            <div className="ml-4 lg:ml-14 -mt-52 absolute   flex gap-5">
                <div className="w-10  flex flex-col  items-center justify-center">
                    ...
                    <div className="Linesw flex justify-center h-52 lg:h-72 bg-orange-600 "></div>
                    <div className="w-10 h-10 bg-orange-600 "></div>

                </div>
                <div className="">
                    <h1 className="text-white/90 font-semibold text-3xl lg:text-6xl ">Manufacturing, Wholesaling & Exporting</h1>
                    <h2 className="text-white/90 font-semibold text-xs lg:text-xl text-balance lg:w-3/4 ">Gutka Plant Machinery, Pan Masala Plant Machinery, Snack Packing Machine, Packing Machine, Nitrogen Flushing Machine, etc.</h2>
                </div>
            </div>
            <div className=" 2xl:ml-36 ml-16 pt-10 sm:ml-32 sm:pt-32 lg:ml-32 lg:pt-32  relative 2xl:pt-32 sm:w-3/4 lg:w-1/2 gap-5 flex flex-col  font-semibold">
